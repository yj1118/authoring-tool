...
export type RecorderCaptureMode = 'recording' | 'scrollIntoView' | 'assertingVisibility' | 'assertingDisabled' | 'assertingNotDisabled' | 'assertingText' | 'assertingValue' | 'assertingSnapshot';
