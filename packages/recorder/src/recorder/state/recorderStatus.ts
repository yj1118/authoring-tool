...
export type RecorderCaptureMode = 'recording' | 'scrollIntoView' | 'assertingVisibility' | 'assertingDisabled' | 'assertingNotDisabled' | 'assertingChecked' | 'assertingUnchecked' | 'assertingText' | 'assertingValue' | 'assertingPasswordInput' | 'assertingSelectOptions' | 'assertingSnapshot';
