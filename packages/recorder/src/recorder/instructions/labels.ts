...
const englishLabels: RecorderInstructionLabels = {
  ...
  selectInitialAssertionTitle: 'Select initial value assertion',
...
const simplifiedChineseLabels: RecorderInstructionLabels = {
  ...
  selectInitialAssertionTitle: '下拉初始值断言',
  selectOptionsAssertionTitle: '下拉选项断言',
  expectedText: '期望文本',
  expectedValue: '期望值',
  expectedSelection: '期望选中项',
  optionTexts: '选项文本',
  optionValues: '选项值',
  containsText: '包含文本',
  containsValue: '包含值',
  containsSelection: '包含选中项',
  matchByText: '按文本匹配',
  matchByValue: '按值匹配',
  exactOptions: '完整匹配',
...
const traditionalChineseLabels: RecorderInstructionLabels = {
  ...
  selectInitialAssertionTitle: '下拉初始值斷言',
  selectOptionsAssertionTitle: '下拉選項斷言',
  expectedText: '期望文字',
  expectedValue: '期望值',
  expectedSelection: '期望選中項',
  optionTexts: '選項文字',
  optionValues: '選項值',
  containsText: '包含文字',
  containsValue: '包含值',
  containsSelection: '包含選中項',
  matchByText: '按文字比對',
  matchByValue: '按值比對',
  exactOptions: '完整比對',
...
const japaneseLabels: RecorderInstructionLabels = {
  ...
  selectInitialAssertionTitle: 'セレクト初期値アサーション',
  selectOptionsAssertionTitle: 'セレクト項目アサーション',
  expectedText: '期待するテキスト',
  expectedValue: '期待する値',
  expectedSelection: '期待する選択項目',
  optionTexts: '項目テキスト',
  optionValues: '項目値',
  containsText: 'テキストを含む',
  containsValue: '値を含む',
  containsSelection: '選択項目を含む',
  matchByText: 'テキストで照合',
  matchByValue: '値で照合',
  exactOptions: '完全一致',
