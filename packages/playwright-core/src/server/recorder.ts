...
function isRecordingMode(mode: Mode) {
  return ['recording', 'scrollIntoView', 'assertingText', 'assertingVisibility', 'assertingDisabled', 'assertingNotDisabled', 'assertingValue', 'assertingSnapshot'].includes(mode);
}
