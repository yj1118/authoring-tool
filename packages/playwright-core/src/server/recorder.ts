...
function isRecordingMode(mode: Mode) {
  return ['recording', 'scrollIntoView', 'assertingText', 'assertingVisibility', 'assertingDisabled', 'assertingNotDisabled', 'assertingChecked', 'assertingUnchecked', 'assertingValue', 'assertingSnapshot'].includes(mode);
}
