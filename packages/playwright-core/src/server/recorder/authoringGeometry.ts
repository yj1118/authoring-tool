...
export const kAuthoringInspectedWidthRatio = 0.7;

export type AuthoringRect = {
  left: number;
  top: number;
  width: number;
  height: number;
...
export type AuthoringScreenPayload = {
  left?: number;
  top?: number;
  width?: number;
  height?: number;
...
export type AuthoringScreenMetrics = {
  workArea: AuthoringRect;
  scaleFactor: number;
  frameInsets: AuthoringInsets;
};

export type AuthoringDockLayout = {
  inspectedBounds: AuthoringRect;
  toolBounds: AuthoringRect;
};

export function normalizeAuthoringScreenMetrics(payload: AuthoringScreenPayload | null | undefined): AuthoringScreenMetrics | null {
...
export function computeAuthoringDockLayout(metrics: AuthoringScreenMetrics, inspectedWidthRatio = kAuthoringInspectedWidthRatio): AuthoringDockLayout {
...
export function computeAuthoringInitialBrowserBounds(metrics: AuthoringScreenMetrics, inspectedWidthRatio = kAuthoringInspectedWidthRatio): AuthoringRect {
  return computeAuthoringDockLayout(metrics, inspectedWidthRatio).inspectedBounds;
}
...
function computeFrameInsets(payload: AuthoringScreenPayload, workArea: AuthoringRect, scaleFactor: number): AuthoringInsets {
...
function applyFrameInsets(bounds: AuthoringRect, frameInsets: AuthoringInsets): AuthoringRect {
  return {
...
function normalizeOptionalRect(left?: number, top?: number, width?: number, height?: number): AuthoringRect | null {
...
function rectRight(rect: AuthoringRect): number {
  return rect.left + rect.width;
}

function rectBottom(rect: AuthoringRect): number {
  return rect.top + rect.height;
}

function zeroInsets(): AuthoringInsets {
  return {
    left: 0,
    top: 0,
    right: 0,
